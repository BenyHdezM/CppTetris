...
void _handlekey(KeySym key)
{
    ...
    case XK_Escape:
        ...
        break;
    case XK_space:
        _teclas.push(miniwin::ESPACIO);
        break;
    case XK_Return:
        _teclas.push(miniwin::RETURN);
        break;
    case XK_Left:
        _teclas.push(miniwin::IZQUIERDA);
        break;
    case XK_Right:
        _teclas.push(miniwin::DERECHA);
        break;
    case XK_Up:
        _teclas.push(miniwin::ARRIBA);
        break;
    case XK_Down:
        _teclas.push(miniwin::ABAJO);
        break;
    default:
    {
...
void _process_event()
{
    ...
    case ButtonPress:
    {
        ...
        {
        case 1:
            _mouse_state.left_button  = true;
            break;
        case 3:
            _mouse_state.right_button = true;
            break;
        }
        break;
    }
    case ButtonRelease:
    {
        ...
        {
        case 1:
            _mouse_state.left_button = false;
            break;
        case 3:
            _mouse_state.right_button = false;
            break;
        }
        break;
    }
